...
class HRPC {
  constructor(stream) {
    ...
    this._requestEncodings = new Map([
      ['@example/hello', getEncoding('@example/hello-request')]
    ])
    this._responseEncodings = new Map([
      ['@example/hello', getEncoding('@example/hello-response')]
    ])
  ...
  async hello(args) {
    return this._call('@example/hello', args)
  }

  onHello(responseFn) {
    this._handlers['@example/hello'] = responseFn
  }
